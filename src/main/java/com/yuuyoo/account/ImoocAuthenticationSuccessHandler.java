...
public class ImoocAuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
	...
	@Autowired
	private AuthorizationCodeServices imoocAuthorizationCodeServices;
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		String type = request.getHeader("response_type");
		if("code".equals(type)){
			makeCode(request,response,authentication);
		}else{
			makeToken(request,response,authentication);
		}
	...
	public void makeCode(HttpServletRequest request, HttpServletResponse response,
		...
		String code = imoocAuthorizationCodeServices.createAuthorizationCode(combinedAuth);
